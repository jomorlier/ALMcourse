...
%example top88_ptBENDING(140, 50, 0.3, 3, 2, 2)
function x=top88_ptBENDING(nelx,nely,volfrac,penal,rmin,ft)
close all
%% MATERIAL PROPERTIES
E0 = 210e3;
Emin = 1e-9;
nu = 0.3;
thickness=10;
Force_amplitude=54e3;
%% PREPARE FINITE ELEMENT ANALYSIS
A11 = [12  3 -6 -3;  3 12  3  0; -6  3 12 -3; -3  0 -3 12];
A12 = [-6 -3  0  3; -3 -6 -3 -6;  0 -3 -6  3;  3 -6  3 -6];
B11 = [-4  3 -2  9;  3 -4 -9  4; -2 -9 -4 -3;  9  4 -3 -4];
B12 = [ 2 -3  4 -9; -3  2  9 -2;  4  9  2  3; -9 -2  3  2];
KE = thickness*1/(1-nu^2)/24*([A11 A12;A12' A11]+nu*[B11 B12;B12' B11]);
...
F = Force_amplitude*sparse(2,1,-1,2*(nely+1)*(nelx+1),1);
U = zeros(2*(nely+1)*(nelx+1),1);
fixeddofs = union([1:2:2*(nely+1)],[(nelx+2)*(nely+1)]);
